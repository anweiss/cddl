...
color_choice = &color_group"#;
    ...
    fn test_ethereum_address_cddl() {
        ...
        assert!(result.is_ok(), "Failed to parse ethereumAddress.cddl: {:?}", result.err());
    }
    ...
    fn test_intellisense_demo_cddl() {
        ...
        let result = CDDLParser::parse(Rule::cddl, &content);
        assert!(result.is_ok(), "Failed to parse intellisense-demo.cddl: {:?}", result.err());
    }
    ...
    fn test_completion_cddl() {
        ...
        let result = CDDLParser::parse(Rule::cddl, &content);
        assert!(result.is_ok(), "Failed to parse completion.cddl: {:?}", result.err());
    }
}
