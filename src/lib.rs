...
//! [![Publish
//! packages](https://github.com/anweiss/cddl/workflows/Publish%20packages/badge.svg?branch=0.9.2&event=release)](https://github.com/anweiss/cddl/actions?query=workflow%3A%22Publish+packages%22)
//! [![Build and
...
//!
//! ```sh
//! docker run -i --rm -v $PWD:/data -w /data ghcr.io/anweiss/cddl-cli:0.9.2 validate --cddl reputon.cddl --stdin < reputon.json
//! ```
//!
//! ## Website
//!
...
//! ```toml
//! [dependencies]
//! cddl = { version = "0.9.2", default-features = false }
//! ```
//!
